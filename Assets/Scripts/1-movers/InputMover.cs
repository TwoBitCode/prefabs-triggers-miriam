...
public class InputMover: MonoBehaviour {
    ...
    void Update() {
        ...
        if (screenBounds.AmIOutOfBounds(transform.position + movementVector)){
            Vector2 newPosition = screenBounds.CalculateWrappedPosition(transform.position+movementVector);
